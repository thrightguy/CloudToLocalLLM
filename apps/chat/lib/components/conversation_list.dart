...
class ConversationList extends StatefulWidget {
  ...
  final Function(Conversation) onConversationDeleted;
  final Function(Conversation, String) onConversationRenamed;
...
class _ConversationListState extends State<ConversationList> {
  ...
  void _finishEditing(Conversation conversation, String newTitle) {
    if (newTitle.trim().isNotEmpty && newTitle.trim() != conversation.title) {
      widget.onConversationRenamed(conversation, newTitle.trim());
    }
    setState(() {
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              ...
              widget.onConversationDeleted(conversation);
            },
