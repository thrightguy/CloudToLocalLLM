...
import 'services/robust_tray_service.dart';
...
class _CloudToLocalLLMAppState extends State<CloudToLocalLLMApp> {
  ...
  Future<void> _initializeSystemTray() async {
    try {
      ...
      final robustTray = RobustTrayService();
      final success = await robustTray.initialize(
        onShowWindow: () {
      ...
      if (success) {
        ...
        // Set initial tooltip
        // Tooltip is set automatically by robust tray service
      } else {
