...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.6.14';
  static const int mainAppBuildNumber = 202506272243;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.6.14';
  static const int tunnelManagerBuildNumber = 202506272243;

  // Shared library version
  static const String sharedLibraryVersion = '3.6.14';
  static const int sharedLibraryBuildNumber = 202506272243;
  ...
  static const String buildTimestamp = '2025-06-28T02:43:51Z';
