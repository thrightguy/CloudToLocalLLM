...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.10.3';
  static const int mainAppBuildNumber = 202507111619;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.10.3';
  static const int tunnelManagerBuildNumber = 202507111619;

  // Shared library version
  static const String sharedLibraryVersion = '3.10.3';
  static const int sharedLibraryBuildNumber = 202507111619;
  ...
  static const String buildTimestamp = '2025-07-11T20:19:10Z';
