...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.5.15';
  static const int mainAppBuildNumber = 202506180832;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.5.15';
  static const int tunnelManagerBuildNumber = 202506180832;

  // Shared library version
  static const String sharedLibraryVersion = '3.5.15';
  static const int sharedLibraryBuildNumber = 202506180832;
  ...
  static const String buildTimestamp = '2025-06-18T12:36:35Z';
