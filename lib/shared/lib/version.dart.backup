...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.5.10';
  static const int mainAppBuildNumber = 202506141427;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.5.10';
  static const int tunnelManagerBuildNumber = 202506141427;

  // Shared library version
  static const String sharedLibraryVersion = '3.5.10';
  static const int sharedLibraryBuildNumber = 202506141427;
  ...
  static const String buildTimestamp = '2025-06-14T18:27:06Z';
