...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.8.3';
  static const int mainAppBuildNumber = 202506291750;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.8.3';
  static const int tunnelManagerBuildNumber = 202506291750;

  // Shared library version
  static const String sharedLibraryVersion = '3.8.3';
  static const int sharedLibraryBuildNumber = 202506291750;
  ...
  static const String buildTimestamp = '2025-06-29T21:50:30Z';
