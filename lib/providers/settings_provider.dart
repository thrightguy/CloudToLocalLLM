...
class SettingsProvider extends ChangeNotifier {
  ...
  bool _autoStartLlm = true;
  bool _installAsService = true;
  ...
  bool get autoStartLlm => _autoStartLlm;
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      if (windowsService != null) {
        ...
        windowsService!.isLmStudioRunning.addListener(_onLlmStatusChanged);
        windowsService!.ollamaVersion.addListener(_onLlmStatusChanged);
      }
  ...
  Future<void> _saveSettings() async {
    try {
      final settings = {
        ...
        'autoStartLlm': _autoStartLlm,
        'installAsService': _installAsService,
      };
