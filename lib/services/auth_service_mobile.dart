  ...
  Future<void> loginWithBiometrics() async {
    try {
      ...
      await _auth0.credentialsManager.enableBiometrics(
        ...
        description: 'Biometric authentication provides secure and convenient access',
  ...
  Future<void> _loadUserProfile() async {
    try {
      if (_credentials?.accessToken != null) {
        ...
        final userProfile = await _auth0.api.userInfo(accessToken: _credentials!.accessToken);
